...
RobotBasePoses::RobotBasePoses(){
    ...
    this->vision.pose.position.x = 1.120;
    this->vision.pose.position.y = 2.885;
    this->vision.pose.position.z = 0.000;

    this->vision.pose.orientation.x = 0.0;
    this->vision.pose.orientation.y = 0.0;
    this->vision.pose.orientation.z = -0.706;
    this->vision.pose.orientation.w = 0.708;

    this->assembly.header.frame_id = this->frame_id_string;

    this->assembly.pose.position.x = -0.300;
    this->assembly.pose.position.y = 3.12; //3.064
    this->assembly.pose.position.z = 0.0;

    this->assembly.pose.orientation.x = 0.0;
    this->assembly.pose.orientation.y = 0.0;
    this->assembly.pose.orientation.z = -0.703;
    this->assembly.pose.orientation.w = 0.711;
