...
#include <model_creation/SendStampedPose.h>
...
int main (int argc, char** argv)
{
  ...
  transformata_finala=calculate_transformation(cluster_vector[1]);
  ransac_detect(cluster_vector[1]);

//  ros::ServiceClient client = nh.serviceClient<model_creation::SendStampedPose>("send_stamped_pose");

  model_creation::SendStampedPose srv;
//  srv.request.msg.pose.position.x = transformata_finala(0,3);
//  srv.request.msg.pose.position.y = transformata_finala(1,3);
//  srv.request.msg.pose.position.z = transformata_finala(2,3);
...
//  srv.request.msg.pose.orientation.w = (double)quat.w();
//  srv.request.msg.pose.orientation.x = (double)quat.x();
//  srv.request.msg.pose.orientation.y = (double)quat.y();
//  srv.request.msg.pose.orientation.z = (double)quat.z();

//  std::cout << "w: " << srv.request.msg.pose.orientation.w
//            << "x: " << srv.request.msg.pose.orientation.x
//            << "y:" << srv.request.msg.pose.orientation.y
//            << "z: " << srv.request.msg.pose.orientation.z
//            << std::endl;
